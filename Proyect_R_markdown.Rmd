...
```{r, warning=FALSE}
ggplot(stroke_data, aes(x = stroke, y = ..count.., fill = Residence_type)) +
  geom_bar(position = "dodge", width = 0.7) +
...
```
```{r, warning=FALSE}
ggplot(stroke_data, aes(x = stroke, y = ..count.., fill = smoking_status)) +
  geom_bar(position = "dodge", width = 0.7) +
...
ggplot(stroke_data, aes(y = bmi, fill =hypertension))+
  geom_boxplot()+
  facet_wrap(~hypertension)+theme_minimal()+labs(title = "Bmi boxplot by Hypertension",x="Hypertension",y="count")+
        theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 16),
    axis.title = element_text(face = "bold", size = 12),
    axis.text = element_text(size = 10),
...
ggplot(stroke_data, aes(y = bmi, fill =heart_disease))+
  geom_boxplot()+
  facet_wrap(~heart_disease)+theme_minimal()+labs(title = "Bmi boxplot by Heart Disease",x="Heart Disease",y="count")+
        theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 16),
    axis.title = element_text(face = "bold", size = 12),
    axis.text = element_text(size = 10),
...
ggplot(stroke_data, aes(y = bmi, fill =work_type))+
  geom_boxplot()+
  facet_wrap(~work_type)+theme_minimal()+labs(title = "Bmi boxplot by Work Type",x="Work Type",y="count")+
        theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 16),
    axis.title = element_text(face = "bold", size = 12),
    axis.text = element_text(size = 10),
...
```
The *bmi* distribution for those who smokes and the one that formerly smoked look similar and those who never smoked and the unknown also look similar. For all the smoking status you can see outliers values. The mean is high in all the groups and those who had have a stroke is a littler bit higher.
...
ggplot(stroke_data, aes(x = gender, y = avg_glucose_level, fill = stroke)) +
  ...
  theme_minimal()+
  labs(
    title = "Distribution of Average Glucose Levels by Gender and Stroke",
    x = "Gender",
    y = "Average Glucose Level (mg/dL)",
    fill = "Gender"
  )+
