...
```
```{r} 
ggplot(data)+aes(x=stroke,fill=gender) + geom_bar(position=position_dodge())
...
```{r} 
ggplot(data)+aes(x=stroke,fill=hypertension) + geom_bar(position=position_dodge())
...
```{r} 
ggplot(data)+aes(x=stroke,fill=heart_disease) + geom_bar(position=position_dodge())
...
```{r} 
ggplot(data)+aes(x=stroke,fill=ever_married) + geom_bar(position=position_dodge())
...
```{r} 
ggplot(data)+aes(x=stroke,fill=work_type) + geom_bar(position=position_dodge())
...
```{r} 
ggplot(data)+aes(x=stroke,fill=Residence_type) + geom_bar(position=position_dodge())
...
```{r} 
ggplot(data)+aes(x=stroke,fill=smoking_status) + geom_bar(position=position_dodge())
