...
```
The *p-value* is larger than 0.05 this mean that there's not evidence of independence between the variables gender and stroke. 
...
2) Diagonal Discriminant Analysis (method = 'dda')

3) Xgboost for classification 0-1
